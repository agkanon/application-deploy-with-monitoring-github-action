...
function install_alertmanager() {
  if [ ! -x /usr/local/bin/alertmanager ]; then
    ...
    curl -fsSL -o /tmp/alertmanager.tar.gz https://github.com/prometheus/alertmanager/releases/download/v${ALERTMANAGER_VERSION}/alertmanager-${ALERTMANAGER_VERSION}.linux-amd64.tar.gz
...
function install_node_exporter() {
  if [ ! -x /usr/local/bin/node_exporter ]; then
    ...
    curl -fsSL -o /tmp/node_exporter.tar.gz https://github.com/prometheus/node_exporter/releases/download/v${NODE_EXPORTER_VERSION}/node_exporter-${NODE_EXPORTER_VERSION}.linux-amd64.tar.gz
